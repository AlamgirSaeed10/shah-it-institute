                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer-link support mt-40">
                        ...
                        <ul>
                            ...
                            <li><a href="#"><i class="fa fa-angle-right"></i>Requirments</a></li>
                        </ul>
                    </div> <!-- support -->
                </div>
                <div class="col-lg-3 col-md-6">
            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="copyright text-md-left text-center pt-15">
                        <p>&copy; All right reserved <?php echo date("Y"); ?> A project by
                            <a target="_blank" href="https://shahcorporationltd.com"> SHAH Corporation limited</a>
                        </p>
                    </div>
                </div>
                <div class="col-md-2">
